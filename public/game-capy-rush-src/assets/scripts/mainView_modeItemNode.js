...
var v = function (t) {
    ...
    return r(this, undefined, undefined, function () {
      ...
      return s(this, function (o) {
        switch (o.label) {
          case 0:
            this._modeId = t;
            return [4, f.myJsonCtl.getJson(p.jsonName.mode)];
          case 1:
            e = o.sent();
            this.lbModeName.string = e[this._modeId].name;
            n = "/modeIcon/img_zhuti" + this._modeId;
            this.imgModeIcon.node.mReloImgFalg = true;
            d.MyTool.loadImg(n, this.imgModeIcon);
            return [2];
        }
      });
    });
  ...
  e.prototype.btnClick_go = function (t) {
    if (h.default.instance.baseBtnClick(this.node.name + t.target.name)) {
      c.ManageCtl.myMsgCtl.emit(l.MyConstans.msg.clickModeItem, this._modeId);
    }
  };
  a([y(cc.Label)], e.prototype, "lbModeName", undefined);
  a([y(cc.Sprite)], e.prototype, "imgModeIcon", undefined);
  return a([m, _("ui/mainView_modeItemNode")], e);
}(u.default);
exports.default = v;