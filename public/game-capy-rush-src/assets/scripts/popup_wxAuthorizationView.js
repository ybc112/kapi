...
var _ = function (t) {
  ...
  e.prototype.gotoClose = function () {
    c.ManageCtl.uiManage.gotoDestroyUI(f.uiPath.uiName.popup_wxAuthorizationView);
  };
  e.prototype.btnClick_get = function (t) {
    p.default.instance.baseBtnClick(this.node.name + t.target.name);
  };
  e.prototype.onReShowRankBtn = function () {
    ...
    if (c.ManageCtl.isWx()) {
      l.default.instance.login(c.ManageCtl.persistRootNode.wxLoginBtnNode2, function (e) {
        if (e) {
          c.ManageCtl.gameData.setFlagData(u.MyConstans.projectName + "_getAuthorization", {});
          c.ManageCtl.gameData.addDayPropById(u.MyConstans.propId.remove, 1);
          c.ManageCtl.myMsgCtl.emit(u.MyConstans.msg.updatePropCount);
          c.ManageCtl.persistRootNode.showTipsUI("获得 移出x1");
          t.gotoClose();
        }
      });
    }
  };
  return a([m, y("ui/popup_wxAuthorizationView")], e);
}(d.default);
exports.default = _;