...
var _ = function (t) {
    ...
    return r(this, undefined, undefined, function () {
      ...
      return s(this, function (a) {
        switch (a.label) {
          case 0:
            this._mId = t;
            this._imgMaterial = this.imgIcon.getMaterial(0);
            return [4, d.myJsonCtl.getJsonInfoByKey(u.jsonName.collect1, t)];
          case 1:
            e = a.sent();
            n = h.ManageCtl.gameData.getRoleCount();
            o = false;
            if (t <= n - 30) {
              if (h.ManageCtl.gameData.getNewRoleFlag && n - 30 == t) {
                this._imgMaterial.effect.setProperty("enableSetColor", 1);
                h.ManageCtl.myMsgCtl.emit(p.MyConstans.msg.showGetNewRole, {
                  mItem: this.node
                });
              } else {
                o = true;
                this._imgMaterial.effect.setProperty("enableSetColor", 0);
              }
            } else {
              this._imgMaterial.effect.setProperty("enableSetColor", 1);
            }
            this.unlockNode.active = o;
            this.lockNode.active = !this.unlockNode.active;
            this.lbName.string = e.Name;
            i = t.toString();
            this.imgIcon.node.mReloImgFalg = true;
            this.imgIcon.node.mLoadName = i;
            l.MyTool.loadImgByName("/houseIcon/", i, this.imgIcon);
            return [2];
        }
      });
    });
  ...
  e.prototype.setIcon = function () {
    var t = this._mId.toString();
    this.imgIcon.node.mReloImgFalg = true;
    this.imgIcon.node.mLoadName = t;
    l.MyTool.loadImgByName("/houseIcon/", t, this.imgIcon);
  };
  a([m(cc.Node)], e.prototype, "lockNode", undefined);
  a([m(cc.Node)], e.prototype, "unlockNode", undefined);
  a([m(cc.Label)], e.prototype, "lbName", undefined);
  a([m(cc.Sprite)], e.prototype, "imgIcon", undefined);
  return a([g, y("ui/collectItemNode_house")], e);
}(c.default);
exports.default = _;