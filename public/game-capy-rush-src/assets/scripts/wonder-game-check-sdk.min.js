...
i = function () {
  return function (t) {
    ...
    (function (e) {
      ...
      t.exports = (p = p || function (t) {
        ...
        var f = s.BufferedBlockAlgorithm = c.extend({
          ...
          _process: function (e) {
            ...
            var s = a / (4 * r);
            var c = (s = e ? t.ceil(s) : t.max((0 | s) - this._minBufferSize, 0)) * r;
            var u = t.min(4 * c, a);
            if (c) {
              for (var d = 0; d < c; d += r) {
        ...
        t.enc.Base64url = {
          stringify: function (t, e) {
            ...
            for (var a = [], r = 0; r < o; r += 3) {
              for (var s = (n[r >>> 2] >>> 24 - r % 4 * 8 & 255) << 16 | (n[r + 1 >>> 2] >>> 24 - (r + 1) % 4 * 8 & 255) << 8 | n[r + 2 >>> 2] >>> 24 - (r + 2) % 4 * 8 & 255, c = 0; c < 4 && r + 0.75 * c < o; c++) {
      ...
      }(Math), s = (r = p).lib, c = s.WordArray, l = s.Hasher, u = r.algo, d = [], h = u.SHA1 = l.extend({
        _doReset: function () {
          this._hash = new c.init([1732584193, 4023233417, 2562383102, 271733878, 3285377520]);
        },
        _doProcessBlock: function (t, e) {
          for (var n = this._hash.words, o = n[0], i = n[1], a = n[2], r = n[3], s = n[4], c = 0; c < 80; c++) {
            if (c < 16) {
              d[c] = 0 | t[e + c];
            } else {
              var l = d[c - 3] ^ d[c - 8] ^ d[c - 14] ^ d[c - 16];
              d[c] = l << 1 | l >>> 31;
            }
            var u = (o << 5 | o >>> 27) + s + d[c];
            u += c < 20 ? 1518500249 + (i & a | ~i & r) : c < 40 ? 1859775393 + (i ^ a ^ r) : c < 60 ? (i & a | i & r | a & r) - 1894007588 : (i ^ a ^ r) - 899497514;
            s = r;
            r = a;
            a = i << 30 | i >>> 2;
            i = o;
      ...
      }), r.SHA1 = l._createHelper(h), r.HmacSHA1 = l._createHmacHelper(h), function (t) {
        var e = p;
        var n = e.lib;
        var o = n.WordArray;
        var i = n.Hasher;
        ...
        var d = i.RIPEMD160 = o.extend({
          ...
          _doProcessBlock: function (t, e) {
            ...
            for (; n < 80; n += 1) {
              P = d + t[e + O[n]] | 0;
              P += n < 16 ? h(p, v, C) + N[0] : n < 32 ? f(p, v, C) + N[1] : n < 48 ? g(p, v, C) + N[2] : n < 64 ? m(p, v, C) + N[3] : y(p, v, C) + N[4];
              P = (P = _(P |= 0, T[n])) + w | 0;
              d = w;
              w = C;
              C = _(v, 10);
              ...
              p = P;
              P = b + t[e + L[n]] | 0;
              P += n < 16 ? y(M, k, I) + A[0] : n < 32 ? m(M, k, I) + A[1] : n < 48 ? g(M, k, I) + A[2] : n < 64 ? f(M, k, I) + A[3] : h(M, k, I) + A[4];
              P = (P = _(P |= 0, R[n])) + S | 0;
              b = S;
              S = I;
              I = _(k, 10);
        ...
        var t = p.lib.BlockCipherMode.extend();
        function e(t, e, n, o) {
          var i;
          var a = this._iv;
          if (a) {
        ...
        return t;
      }(), p.mode.CTR = (a = (i = p.lib.BlockCipherMode.extend()).Encryptor = i.extend({
        processBlock: function (t, e) {
          var n = this._cipher;
          var o = n.blockSize;
          var i = this._iv;
      ...
      }), i.Decryptor = a, i), p.mode.CTRGladman = function () {
        var t = p.lib.BlockCipherMode.extend();
        function e(t) {
          if ((t >> 24 & 255) == 255) {
            var e = t >> 16 & 255;
        ...
        t.Decryptor = e;
        return t;
      }(), p.mode.ECB = ((o = p.lib.BlockCipherMode.extend()).Encryptor = o.extend({
        processBlock: function (t, e) {
        ...
        pad: function (t, e) {
          ...
          t.concat(p.lib.WordArray.random(o - 1)).concat(p.lib.WordArray.create([o << 24], 1));
        },
        unpad: function (t) {
          var e = 255 & t.words[t.sigBytes - 1 >>> 2];
          t.sigBytes -= e;
        ...
        pad: function (t, e) {
          t.concat(p.lib.WordArray.create([2147483648], 1));
          p.pad.ZeroPadding.pad(t, e);
        },
        unpad: function (t) {
          p.pad.ZeroPadding.unpad(t);
          t.sigBytes--;
        }
      }, p.pad.ZeroPadding = {
        pad: function (t, e) {
        ...
        var g = n.AES = e.extend({
            ...
            if (!this._nRounds || this._keyPriorReset !== this._key) {
              for (var t = this._keyPriorReset = this._key, e = t.words, n = t.sigBytes / 4, i = 4 * ((this._nRounds = n + 6) + 1), a = this._keySchedule = [], r = 0; r < i; r++) {
                if (r < n) {
                  ...
                  if (r % n) {
                    if (n > 6 && r % n == 4) {
                      p = o[p >>> 24] << 24 | o[p >>> 16 & 255] << 16 | o[p >>> 8 & 255] << 8 | o[255 & p];
                    }
                  } else {
                    p = o[(p = p << 8 | p >>> 24) >>> 24] << 24 | o[p >>> 16 & 255] << 16 | o[p >>> 8 & 255] << 8 | o[255 & p];
                    p ^= f[r / n | 0] << 24;
                  }
                  a[r] = a[r - n] ^ p;
                }
              ...
              for (var s = this._invKeySchedule = [], c = 0; c < i; c++) {
                ...
                s[c] = c < 4 || r <= 4 ? p : l[o[p >>> 24]] ^ u[o[p >>> 16 & 255]] ^ d[o[p >>> 8 & 255]] ^ h[o[255 & p]];
              }
            }
          },
          ...
          decryptBlock: function (t, e) {
            ...
            t[e + 1] = t[e + 3];
            t[e + 3] = n;
            this._doCryptBlock(t, e, this._invKeySchedule, l, u, d, h, i);
            n = t[e + 1];
            t[e + 1] = t[e + 3];
            t[e + 3] = n;
          },
    ...
    n.r(e);
    n.d(e, "WonderErrorName", function () {
      return r;
    });
    n.d(e, "WonderError", function () {
      return c;
    });
    n.d(e, "WonderRequestError", function () {
      return l;
    });
    n.d(e, "WonderNetworkError", function () {
      return u;
    });
    var o = {};
    n.r(o);
    n.d(o, "inIframe", function () {
      return d;
    });
    n.d(o, "randomStr", function () {
      return h;
    });
    n.d(o, "getUrl", function () {
      return g;
    });
    n.d(o, "getLStr", function () {
      return m;
    });
    var i = {};
    n.r(i);
    n.d(i, "encrypt", function () {
      return b;
    });
    n.d(i, "decrypt", function () {
      return M;
    });
    var a;
    var r;
    ...
    !function (t) {
      t.InvalidParams = "InvalidParams";
      t.InvalidFile = "InvalidFile";
      t.InvalidToken = "InvalidToken";
      t.InvalidMetadata = "InvalidMetadata";
      t.InvalidChunkSize = "InvalidChunkSize";
      t.InvalidCustomVars = "InvalidCustomVars";
      t.NotAvailableUploadHost = "NotAvailableUploadHost";
      t.ReadCacheFailed = "ReadCacheFailed";
      t.InvalidCacheData = "InvalidCacheData";
      t.WriteCacheFailed = "WriteCacheFailed";
      t.RemoveCacheFailed = "RemoveCacheFailed";
      t.GetCanvasContextFailed = "GetCanvasContextFailed";
      t.UnsupportedFileType = "UnsupportedFileType";
      t.FileReaderReadFailed = "FileReaderReadFailed";
      t.NotAvailableXMLHttpRequest = "NotAvailableXMLHttpRequest";
      t.InvalidProgressEventTarget = "InvalidProgressEventTarget";
    ...
    var l = function (t) {
      function e(e, n, o, i) {
        var a = t.call(this, r.RequestError, o) || this;
        a.code = e;
        a.reqId = n;
        a.isRequestError = true;
        a.data = i;
        return a;
      }
      s(e, t);
    ...
    function h() {
      return (100000 * Math.random()).toString(36) + "" + (100000 * Math.random()).toString(10);
    }
    var p = {
      iI: [4, 5, 2, 6, 0, 7, 8, 9, 10, 11, 12, 0, 4, 13, 14, 8],
      mI: [15, 8, 16, 17, 1, 2, 3, 17, 18, 19, 18],
      akI: [20, 21, 3, 5, 22, 0, 23, 13, 0, 24, 25, 26, 9, 27, 9, 21],
      dnI: [28, 5, 5, 29, 30, 31, 32, 32, 33, 7, 34, 35, 36, 9, 12, 24, 37, 24, 7, 23, 33, 6, 24, 23, 33, 6, 12, 36, 23, 35, 5],
      dnDevI: [28, 5, 5, 29, 31, 32, 32, 38, 39, 11, 7, 38, 36, 38, 30, 7, 40, 12, 41, 7, 36, 11, 39, 34, 31, 2, 0, 0, 0, 2],
      ckI: [32, 11, 39, 34, 34, 39, 23, 32, 11, 28, 35, 11, 40, 32, 24, 30],
      nt: [5, 39, 40, 35, 23],
      tx: [42, 17, 5, 39, 40, 35, 23],
      qs: [43],
      apmI: [7, 29, 29, 44, 23, 7, 34, 35],
      tttI: [32, 11, 39, 34, 34, 39, 23, 32, 5, 5, 32, 30, 35, 30, 30, 24, 39, 23, 32, 30, 24, 33, 23, 44, 24, 23],
      tttAcI: [7, 23, 39, 23, 6, 34, 39, 12, 30, 44, 11, 39, 45, 35],
      wwxCcI: [32, 11, 39, 34, 34, 39, 23, 32, 30, 35, 30, 30, 24, 39, 23, 32, 11, 28, 35, 11, 40, 44, 11, 39, 45, 35],
      wwxCI: [11, 39, 45, 35],
      lI: [38, 39, 33, 24, 23],
      s: [326, 327, 328, 334, 397, 394, 399, 375, 347, 400, 349, 377, 395, 362, 346, 343, 361, 323, 345, 344, 356, 357, 363, 388, 383, 354, 359, 350, 382, 390, 393, 336, 325, 381, 387, 379, 324, 391, 386, 389, 385, 392, 398, 341, 373, 378]
    };
    function f(t) {
      var e = "";
      t.forEach(function (t) {
        e += String.fromCharCode(p.s[t] - 278);
      });
      return e;
    }
    function g(t) {
    ...
    var C = o.getLStr("iI");
    var w = {
      iv: _.a.enc.Utf8.parse(C),
      mode: _.a.mode.CBC,
      padding: _.a.pad.Pkcs7
    };
    function b(t) {
      var e = _.a.enc.Utf8.parse(v);
      var n = _.a.enc.Utf8.parse(t);
      return _.a.AES.encrypt(n, e, w).toString();
    }
    function M(t) {
      var e = _.a.enc.Utf8.parse(v);
      var n = _.a.AES.decrypt(t, e, w);
      return _.a.enc.Utf8.stringify(n).toString();
    }
    var k = function () {
      function t(t) {
        this.logger = t;
      ...
      t.prototype.get = function (t, e, n) {
        ...
        return new Promise(function (i, a) {
          ...
          o.send(t, "GET", null, e, n).then(function (t) {
            if (t.status == 200) {
              i(t.data);
            } else {
              a(t);
            }
            o.logger.info("get then success", t);
          }).catch(function (t) {
            o.logger.info("get catch", t.toJSON());
            var e = t.toJSON();
            var n = {
              type: "error",
              message: e.message
            ...
            if (e.message.includes("timeout")) {
              o.logger.info("`get` catch", "timeout");
              n.type = "timeout";
              n.message = e.message;
            }
            a(n);
      ...
      t.prototype.post = function (t, e, n, o) {
        ...
        return new Promise(function (a, r) {
          i.send(t, "POST", e, n, o).then(function (t) {
            if (t.status == 200) {
              a(t.data);
            } else {
              r(t);
            }
            i.logger.info("post then success", t);
          }).catch(function (t) {
            i.logger.info("post catch", t.toJSON());
            var e = t.toJSON();
            var n = {
              type: "error",
              message: e.message
            ...
            if (e.message.includes("timeout")) {
              i.logger.info("post catch", "timeout");
              n.type = "timeout";
              n.message = e.message;
            }
            r(n);
      ...
      t.prototype.send = function (t, e, n, o, i) {
        var a = this;
        return new Promise(function (r, s) {
          ...
          if (n) {
            var d = [];
            for (var h in n) {
              d.push(h + "=" + encodeURIComponent(n[h]));
            }
            if ((c = d.join("&")).length) {
    ...
    var I = function () {
      ...
      t.prototype.check = function () {
        ...
        return new Promise(function (e, n) {
          ...
          var r = o.randomStr();
          var s = i.encrypt(r);
          s = (s = s.replace(/\+/g, "_")).replace(/\//g, "-");
          var c = o.getUrl("ckI") + o.getLStr("qs") + o.getLStr("nt") + "=" + s;
          (a = {})[o.getLStr("tx")] = s;
          var l = a;
          new k(t.logger).get(c, l, 1000).then(function (t) {
            var o = t.data.di;
            if ((o = JSON.parse(i.decrypt(o))).x_token === r) {
              e({
                code: "success",
                data: t
              });
    ...
    var S = function () {
      ...
      t.prototype.checkWx = function (t) {
        var e = this;
        return new Promise(function (n, i) {
          ...
          if (!e.bmsAppName) {
            i({
              code: "INTERNAL_ERROR",
              message: "bmsAppName is null"
            });
          }
          var r = o.getUrl("wwxCcI");
          (a = {})[o.getLStr("wwxCI")] = t;
          a[o.getLStr("apmI")] = e.bmsAppName;
          var s = a;
          new k(e.logger).post(r, s, {
            "Content-Type": "application/x-www-form-urlencoded"
          }, 3000).then(function (t) {
            e.logger.info(t);
            if (t.code !== 0) {
              i(t);
            } else {
      ...
      t.prototype.checkTt = function (t) {
        var e = this;
        return new Promise(function (n, i) {
          var a;
          if (!e.bmsAppName) {
    ...
    var P = function (t, e) {
      ...
      var r = [];
      try {
        for (; (e === undefined || e-- > 0) && !(o = a.next()).done;) {
          r.push(o.value);
        }
      } catch (t) {
        i = {
    ...
    var A = function () {
      ...
      t.isLegalLogLevel = function (t) {
        return [N.VERBOSE, N.INFO, N.WARNING, N.ERROR, N.NONE].includes(t);
      };
      t.prototype.getPrintPrefix = function (t) {
        this.id++;
        return "[wonder-game-check-sdk] " + function (t, e) {
          var n = {
            "M+": t.getMonth() + 1,
            "d+": t.getDate(),
          ...
          return e;
        }(new Date(), "yyyy-MM-ddThh:mm:ss.SZ") + " [" + t.toLocaleUpperCase() + "][" + this.prefix + "#" + this.id + "]:";
      };
      ...
      t.prototype.info = function () {
        ...
        if (n.includes(this.level)) {
          console.log.apply(console, D([this.getPrintPrefix("info")], t));
        }
      };
      t.prototype.warn = function () {
        ...
        var n = ["info", "warn"];
        if (n.includes(this.level)) {
          console.warn.apply(console, D([this.getPrintPrefix("warn")], t));
        }
      };
      t.prototype.error = function () {
        ...
        if (n.includes(this.level)) {
          console.error.apply(console, D([this.getPrintPrefix("error")], t));
        }
      };
      t.prototype.verbose = function () {
        ...
        var n = ["info", "warn", "error", "verbose"];
        if (n.includes(this.level)) {
          console.error.apply(console, D([this.getPrintPrefix("verbose")], t));
        }
      };
      t.id = 0;
      t.LOG_LEVEL = {
    ...
    var O = new (function () {
      ...
      t.prototype.initSdk = function (t) {
        ...
        var n = new A(e.logLevel);
        n.info("initSdk>>>defaultConfig", e);
        if (!A.isLegalLogLevel(e.logLevel)) {
          e.logLevel = A.LOG_LEVEL.INFO;
          return void n.error("参数logLevel需为" + JSON.stringify(A.LOG_LEVEL) + "中的其一");
        }
        this.h5 = new I(n);
        this.miniGame = new S(e.bmsAppName, n);
        if (e && e.onReady && typeof e.onReady == "function") {
          e.onReady();
        }
      };
      return t;
