...
var p = function (_) {
  ...
  o.prototype._uninstallAllData = function () {
    ...
    this._subAssetsDef(this._loadedUrls);
    this._loadedUrls = [];
    this._audioCaches = [];
                    ...
                    return m(this, function (f) {
                      switch (f.label) {
                        ...
                        case 2:
                          ...
                          this._addAssetsDef([e]);
                          this._loadedUrls.push(e);
                          return [3, 4];
                        case 3:
                          d = f.sent();
                          console.log(d);
                    ...
                    return m(this, function (f) {
                      switch (f.label) {
                        ...
                        case 2:
                          ...
                          this._addAssetsDef([i]);
                          this._loadedUrls.push(i);
                          return [3, 4];
                        case 3:
                          d = f.sent();
                          console.log(d);
  ...
  o.prototype._uninstallLevelCWDGSprite = function () {
    if (this.cwNode && cc.isValid(this.cwNode)) {
      this.cwNode.getComponent(cc.Sprite).spriteFrame = null;
    }
    if (this.dgNode && cc.isValid(this.dgNode)) {
      ...
      return m(this, function (m) {
        switch (m.label) {
          case 0:
            ...
            f = window.BrainLevelBaseReleaseAssetC || 0;
            this._loadedUrls = o.map(function (_) {
              return _.url;
            });
            this._addAssetsDef(this._loadedUrls);
            if (f >= 5) {
        ...
        switch (f.label) {
          ...
          case 16:
            if (this._loadAssetPipe) {
              ...
              if (this._loadImportantAssetTotal == 0) {
                this._assetLoadHandle();
              }
              return [2];
            } else {
  ...
  o.prototype._downloadSpriteFrame = function (_, o) {
    ...
    return new Promise(function (t, i) {
      if (a.ASSET_LOCAL_BUNDLE && e.isLocalLv()) {
  ...
  o.prototype._downloadSpine = function (_) {
    ...
    return new Promise(function (e, t) {
      if (a.ASSET_LOCAL_BUNDLE && o.isLocalLv()) {
  ...
  o.prototype._addAssetsDef = function (_) {
    if (_ === undefined) {
      _ = [];
    }
    var o = window.BrainLevelBaseCachesDefs || {};
    ...
    window.BrainLevelBaseCachesDefs = o;
  };
  o.prototype._subAssetsDef = function (_) {
    if (_ === undefined) {
      _ = [];
    }
    var o = window.BrainLevelBaseCachesDefs || {};
  ...
  o.prototype._releaseCacheTextureAsset = function (_) {
    ...
    var e = window.BrainLevelBaseCachesDefs || {};
    var t = function (t) {
      if (-1 != t.indexOf("texture/") && !_.some(function (_) {
        return _ == t;
      }) && (!e[t] || e[t] <= 0)) {
        if (o[t] instanceof cc.SpriteAtlas) {
          var i = o[t];
          for (var d in i._spriteFrames) {
            var f = i._spriteFrames[d];
            cc.assetManager.releaseAsset(f.getTexture());
            cc.assetManager.releaseAsset(f);
          }
          cc.assetManager.releaseAsset(i);
        } else {
          cc.assetManager.releaseAsset(o[t]);
        }
        delete e[t];
        delete o[t];
      }
  ...
  o.prototype._releaseCacheSpineAsset = function (_) {
    ...
    var e = window.BrainLevelBaseCachesDefs || {};
    var t = function (t) {
      if (!(-1 == t.indexOf("spine/") || _.some(function (_) {
        return _ == t;
      }) || _.some(function (_) {
        return _ == t;
      }) || e[t] && !(e[t] <= 0))) {
        o[t].forEach(function (_) {
  ...
  o.prototype._releaseAllCache = function () {
    ...
    this._releaseCacheSpineAsset();
    window.BrainLevelBaseCaches = {};
    window.BrainLevelBaseCachesDefs = {};
  };
  ...
  o.prototype.isLocalLv = function () {
    return true;
  };
  d([l({
    tooltip: "关卡ID"
