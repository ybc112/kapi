...
var _ = function (t) {
  ...
  e.prototype.btnClick_close = function (t) {
    if (h.default.instance.baseBtnClick(this.node.name + t.target.name)) {
      c.ManageCtl.myMsgCtl.emit(l.MyConstans.msg.showLevelView);
      this.gotoClose();
    }
  };
  ...
  e.prototype.gotoClose = function () {
    c.ManageCtl.uiManage.gotoDestroyUI(f.uiPath.uiName.popup_gameWarningView);
  };
  return a([m, y("ui/popup_gameWarningView")], e);
}(u.default);
exports.default = _;