...
var d = function (t) {
  ...
  e.prototype.setGray = function () {
    if (this.node.getComponent(cc.Sprite)) {
      this.node.getComponent(cc.Sprite).setMaterial(0, this.graySpriteMaterial);
    }
  };
  e.prototype.setGeneral = function () {
    if (this.node.getComponent(cc.Sprite)) {
      this.node.getComponent(cc.Sprite).setMaterial(0, this.generalSpriteMaterial);
    }
  };
  a([l({
    type: cc.Material
  ...
  return a([c, u("ui/common/common_setGraySprite")], e);
}(r.default);
exports.default = d;