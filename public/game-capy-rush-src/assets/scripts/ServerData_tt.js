...
var r = require("./SdkConfig");
var s = require("./MyMsgCtl");
var c = require("./gameData");
var l = function () {
  function t() {
  ...
  t.prototype.setGetDataDoneFlagDone = function () {
    this.getDataDoneFlag = true;
  };
  t.prototype.isGetDataDoneFlagDone = function () {
    return this.getDataDoneFlag;
  };
  t.prototype.checkGetServerData = function () {
    if (a.default.isZJTD && !this.getDataDoneFlag) {
      var t = a.default.BMS_APP_NAME;
      var e = window.ywkjTT_openidStr || "null";
      if (e != "") {
        this.getServerData(t, e, "modePassLv");
      }
    }
  };
  t.prototype.checkSaveServerData = function (e, n) {
    if (a.default.isZJTD) {
      var o = window.ywkjTT_openidStr || "null";
      if (o != "null") {
        t.GetInstance().saveServerData(a.default.BMS_APP_NAME, o, e, n);
      }
    }
  };
    ...
    this.httpRequest("https://game.zuiqiangyingyu.net/" + this.API_GETDATA, {
      ...
      if (t && t.data && t.data.data) {
        ...
        if (e) {
          ...
          if (e.modePassLv) {
            c.default.GetInstance().setModePassLvByStr(e.modePassLv);
          }
          o.getDataDoneFlag = true;
          s.default.GetInstance().emit(r.MyConstans.msg.loadServerDataDone);
        }
      }
    }, false, "GET");
  };
  t.prototype.saveServerData = function (t, e, n, a) {
    var r = this;
    if (this.getDataDoneFlag) {
      console.log("## saveServerData  d_key:   " + n + "  d_data:  " + a);
            ...
            switch (i.label) {
              ...
              case 1:
                ...
                if (o) {
                  try {
                    r = JSON.parse(o);
                    console.log("##  saveServerData ", JSON.stringify(r));
                    r = r.data;
                    s(r);
                  } catch (c) {
                    s({});
