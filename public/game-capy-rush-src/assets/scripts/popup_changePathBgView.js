...
var y = function (t) {
  ...
  e.prototype.gotoClose = function () {
    c.ManageCtl.uiManage.gotoDestroyUI(p.uiPath.uiName.popup_changePathBgView);
  };
  e.prototype.editBoxR = function () {
    ...
    if (!(isNaN(Number(o)) || isNaN(Number(i)) || isNaN(Number(a)))) {
      ...
      c.ManageCtl.gameData.pathTextColor = r;
      c.ManageCtl.myMsgCtl.emit(l.MyConstans.msg.changePathBg);
    }
  };
  e.prototype.btnClick_colorBg = function (t, e) {
    if (h.default.instance.baseBtnClick(this.node.name + t.target.name, 0.3)) {
      ...
      c.ManageCtl.gameData.pathTextColor = o;
      c.ManageCtl.myMsgCtl.emit(l.MyConstans.msg.changePathBg);
    }
  };
  e.prototype.btnClick_size = function (t, e) {
    if (h.default.instance.baseBtnClick(this.node.name + t.target.name, 0.3)) {
      var n = e;
      c.ManageCtl.gameData.pathSizeStr = n;
      c.ManageCtl.myMsgCtl.emit(l.MyConstans.msg.changePathBg);
    }
  };
  return a([g, m("ui/popup_changePathBgView")], e);
}(u.default);
exports.default = y;