...
var g = function (t) {
  ...
  e.prototype.setInfo = function (t) {
    return r(this, undefined, undefined, function () {
      ...
      return s(this, function () {
        ...
        n = e.get;
        o = this.imgIcon.getComponent(cc.Sprite);
        i = "/collect/img_cangpin_s" + t;
        o.node.mReloImgFalg = true;
        u.MyTool.loadImg(i, o);
        this.unlockNode.active = t <= n;
        if (t == n && c.ManageCtl.gameData.haveGetNewCollectFlag) {
  ...
  a([p(cc.Sprite)], e.prototype, "imgIcon", undefined);
  return a([h, f("ui/roleLvItemNode")], e);
}(l.default);
exports.default = g;