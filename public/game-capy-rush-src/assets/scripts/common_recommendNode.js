...
var _ = function (t) {
  ...
  e.prototype.onLoad = function () {
    ...
    this._modeIcon = this.dict.modeIcon.getComponent(cc.Sprite);
  };
  e.prototype.onDestroy = function () {};
  e.prototype.start = function () {
    if (c.ManageCtl.gameData.getCurModeId() == 1) {
      if (window.inLiveUser) {
        var t = c.ManageCtl.bmsCtl.getConditionValueByType("zbtj");
        if (!t || t && t.length < 2) {
          ...
          this._showModeId = n;
          if (e != 0 || n != 0) {
            if (c.ManageCtl.gameData.getCurLevelId() >= e) {
              this.node.active = true;
              return void this.showInfo(n);
            }
            this.node.active = false;
          } else {
            this.node.active = false;
    ...
    return r(this, undefined, undefined, function () {
      ...
      return s(this, function (o) {
        switch (o.label) {
          ...
          case 1:
            if (e = o.sent()) {
              this._lbModeName.string = e.Name;
              n = t.toString();
              this._modeIcon.node.mReloImgFalg = true;
              this._modeIcon.node.mLoadName = n;
              d.MyTool.loadImgByName("/modeIcon/mode_", n, this._modeIcon);
              return [2];
            } else {
              return [2];
            }
  ...
  e.prototype.btnClick_go = function (t) {
    if (h.default.instance.baseBtnClick(this.node.name + t.target.name, 0.3) && -1 != this._showModeId) {
      c.ManageCtl.myMsgCtl.emit(l.MyConstans.msg.showPopup_modeView, {
        beginShowModeId: this._showModeId
      });
    }
  };
  return a([m, y("ui/common_recommendNode")], e);
}(u.default);
exports.default = _;